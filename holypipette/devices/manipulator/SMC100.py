'''
Manipulator class for Newport SMC 100 controller.
Based on pySMC100:
https://github.com/freespace/pySMC100/blob/master/smc100.py

This seems to be a single axis.
Note: this assumes that the stage's units are mm. But this depends on the stage.

See also:
    https://github.com/jkrauth/labdevices/blob/main/labdevices/newport.py
'''
...
#### MAIN CLASS ####
class SMC100(SerialDevice, Manipulator):
    ...
    def move_relative_mm(self, dist_mm, wait_stop=True):
        """
    ...
    def relative_move(self, dist_um, axis=None, **kwargs):
        """
    ...
    def absolute_move(self, position_um, axis=None, **kwargs):
        """
